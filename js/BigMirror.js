...
jQuery.fn.extend(
	{
		bigMirror:function(obj){				
				...
				BigMirrors.prototype.createBigMirrorsUI=function(left,top){
					...
					let str = "<div style='position:absolute;left:"+this.left+"px;top:"+this.top+"px;width:"+this.mirrorWidth+"px;height:"+this.mirrorHeight+"px;background-color:rgba(248,168,157,0.3)'></div>";
